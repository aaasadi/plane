      ...
      <div ref={ref} className="flex h-full w-full flex-col gap-y-4">
        ...
        <div className="flex flex-shrink-0 flex-grow items-end px-6 py-2">
          ...
          >
            ...
            <button
              type="button"
              className={`ms-auto hidden place-items-center rounded-md p-1.5 text-custom-text-200 outline-none hover:bg-custom-background-90 hover:text-custom-text-100 md:grid ${

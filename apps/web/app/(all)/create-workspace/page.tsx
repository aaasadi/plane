    ...
    <AuthenticationWrapper>
      <div className="flex h-full flex-col gap-y-2 overflow-hidden sm:flex-row sm:gap-y-0">
        <div className="relative h-1/6 flex-shrink-0 sm:w-2/12 md:w-3/12 lg:w-1/5">
          ...
          <Link
            className="absolute start-5 top-1/2 grid -translate-y-1/2 place-items-center bg-custom-background-100 px-3 sm:start-1/2 sm:top-12 sm:-translate-x-[15px] sm:translate-y-0 sm:px-0 sm:py-5 md:start-1/3"
            href="/"
          >

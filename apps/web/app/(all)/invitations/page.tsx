    ...
    <AuthenticationWrapper>
      <div className="flex h-full flex-col gap-y-2 overflow-hidden sm:flex-row sm:gap-y-0">
        <div className="relative h-1/6 flex-shrink-0 sm:w-2/12 md:w-3/12 lg:w-1/5">
          <div className="absolute start-0 top-1/2 h-[0.5px] w-full -translate-y-1/2 border-b-[0.5px] border-custom-border-200 sm:start-1/2 sm:top-0 sm:h-screen sm:w-[0.5px] sm:-translate-x-1/2 sm:translate-y-0 sm:border-r-[0.5px] md:start-1/3" />
          <Link
            href="/"
            className="absolute start-5 top-1/2 grid -translate-y-1/2 place-items-center bg-custom-background-100 px-3 sm:start-1/2 sm:top-12 sm:-translate-x-[15px] sm:translate-y-0 sm:px-0 sm:py-5 md:start-1/3 z-10"
          >
            <PlaneLogo className="h-9 w-auto text-custom-text-100" />
          </Link>
          <div className="absolute end-4 top-1/4 -translate-y-1/2 text-sm text-custom-text-100 sm:fixed sm:end-16 sm:top-12 sm:translate-y-0 sm:py-5">
            {currentUser?.email}
          </div>
        </div>
        {invitations ? (

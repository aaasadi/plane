...
export const ExtendedSidebarWrapper: FC<Props> = observer((props) => {
  ...
  return (
    <div
      ...
      className={cn(
        `absolute h-full z-[19] flex flex-col py-2 transform transition-all duration-300 ease-in-out bg-custom-sidebar-background-100 border-e border-custom-sidebar-border-200 p-4 shadow-sm`,
        {

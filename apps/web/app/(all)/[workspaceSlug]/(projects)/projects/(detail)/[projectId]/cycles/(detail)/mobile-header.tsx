  ...
  return (
    <>
      ...
      <div className="flex justify-evenly py-2 border-b border-custom-border-200 md:hidden bg-custom-background-100">
        ...
        <div className="flex flex-grow justify-center border-s border-custom-border-200 items-center text-custom-text-200 text-sm">
          <FiltersDropdown
            ...
            menuButton={
              <span className="flex items-center text-custom-text-200 text-sm">
                {t("common.display")}
                <ChevronDownIcon className="text-custom-text-200 h-4 w-4 ms-2" />
              </span>
            }
          >
        ...
        <span
          ...
          className="flex flex-grow justify-center text-custom-text-200 text-sm border-s border-custom-border-200"
        >
          {t("common.analytics")}
        </span>
      </div>

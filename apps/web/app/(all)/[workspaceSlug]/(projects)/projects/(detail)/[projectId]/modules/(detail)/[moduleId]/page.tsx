      ...
      {error ? (
        ...
        <div className="flex h-full w-full">
          ...
          {!isSidebarCollapsed && (
            <div
              className={cn(
                "flex h-full w-[24rem] flex-shrink-0 flex-col gap-3.5 overflow-y-auto border-s border-custom-border-100 bg-custom-sidebar-background-100 px-6 duration-300 vertical-scrollbar scrollbar-sm absolute end-0 z-[13]"
              )}
              style={{
                boxShadow:

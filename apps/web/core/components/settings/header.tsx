    ...
    >
      <Link
        ...
        className={cn(
          ...
          "md:absolute start-2 top-9 group flex  gap-2 text-custom-text-300 mb-4 border border-transparent w-fit rounded-lg ",
      ...
      <Link
        ...
        className={cn(
          ...
          !isScrolled ? "hover:bg-custom-background-100 hover:border-custom-border-200 items-center pe-2 " : " h-0 m-0"
        )}
      >
        <button
          className={cn(

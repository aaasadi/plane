...
export const NotificationHeaderMenuOption = observer(() => {
  ...
  return (
    <PopoverMenu
      ...
      buttonClassName="flex-shrink-0 w-5 h-5 flex justify-center items-center overflow-hidden cursor-pointer transition-all hover:bg-custom-background-80 bg-custom-background-100 rounded-xs outline-none"

    ...
    <div className="relative w-full flex-shrink-0 py-3">
      {readOnly ? (
        ...
        <div className="relative">
          ...
          <div
            className={cn(
              "pointer-events-none absolute bottom-1 end-1 z-[2] font-normal rounded bg-custom-background-100 p-0.5 text-xs text-custom-text-200 opacity-0 transition-opacity",
              {

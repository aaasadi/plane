...
export const IssueColumn = observer((props: Props) => {
  ...
  return (
    ...
    >
      <td
        tabIndex={0}
        className="h-11 min-w-36 text-sm after:absolute after:w-full after:bottom-[-1px] after:border after:border-custom-border-100 border-e-[1px] border-custom-border-100"
        ref={tableCellRef}
      >
        <Column
          issue={issueDetail}

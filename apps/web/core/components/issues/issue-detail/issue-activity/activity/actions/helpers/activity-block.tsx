...
export const IssueActivityBlockComponent: FC<TIssueActivityBlockComponent> = (props) => {
  ...
  return (
    ...
    >
      <div className="absolute start-[13px] top-0 bottom-0 w-0.5 bg-custom-background-80" aria-hidden />
      <div className="flex-shrink-0 w-7 h-7 rounded-full overflow-hidden flex justify-center items-center z-[4] bg-custom-background-80 transition-border duration-1000 border-2 border-transparent text-custom-text-200">

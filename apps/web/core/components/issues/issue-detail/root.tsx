    ...
    <>
      {!issue ? (
        ...
        <div className="flex h-full w-full overflow-hidden">
          ...
          <div
            className="fixed end-0 z-[5] h-full w-full min-w-[300px] border-s border-custom-border-200 bg-custom-sidebar-background-100 py-5 sm:w-1/2 md:relative md:w-1/3 lg:min-w-80 xl:min-w-96"

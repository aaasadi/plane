...
export const GanttChartSidebar: React.FC<Props> = observer((props) => {
  ...
  return (
    ...
    >
      <Row
        className="group/list-header box-border flex-shrink-0 flex items-end justify-between gap-2 border-b-[0.5px] border-custom-border-200 pb-2 pe-4 text-sm font-medium text-custom-text-300 sticky top-0 z-10 bg-custom-background-100"
        style={{

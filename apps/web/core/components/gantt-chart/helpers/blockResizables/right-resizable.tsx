  ...
  return (
    <>
      {(isHovering || isRightResizing) && dateString && (
        <div className="z-[10] absolute flex text-xs font-normal text-custom-text-300 h-full w-32 -end-36 justify-start items-center">
      ...
      <div
        ...
        className="absolute -end-1.5 top-1/2 -translate-y-1/2 z-[6] h-full w-3 cursor-col-resize rounded-md"
      />
      <div
        className={cn(

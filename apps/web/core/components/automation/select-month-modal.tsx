      ...
      <Dialog as="div" className="relative z-30" onClose={onClose}>
        ...
        <div className="fixed inset-0 z-10 overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-4 text-center sm:p-0">
            ...
            >
              <Dialog.Panel className="relative transform rounded-lg bg-custom-background-100 px-4 pb-4 pt-5 text-start shadow-custom-shadow-md transition-all sm:my-8 sm:w-full sm:max-w-2xl sm:p-6">
                              ...
                              render={({ field: { value, onChange, ref } }) => (
                                <div className="relative flex w-full flex-col justify-center gap-1">
                                  <Input
                                    ...
                                    max={12}
                                  />
                                  <span className="absolute end-8 top-2.5 text-sm text-custom-text-200">Months</span>
                                </div>
                              )}
                            />

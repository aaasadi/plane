  ...
  return (
    ...
    >
      ...
      {isDraggingOver && enableDragDrop && (
        <div className="absolute top-0 start-0 h-full w-full flex items-center justify-center text-sm font-medium text-custom-text-300 rounded bg-custom-background-80/85 border-[1px] border-custom-border-300 z-[2]">

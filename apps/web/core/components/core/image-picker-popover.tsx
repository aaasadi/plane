...
export const ImagePickerPopover: React.FC<Props> = observer((props) => {
  ...
  return (
    <Popover className="relative z-19" ref={ref} tabIndex={tabIndex} onKeyDown={handleKeyDown}>
      ...
      {isOpen && (
        <Popover.Panel
          className="absolute end-0 z-20 mt-2 rounded-md border border-custom-border-200 bg-custom-background-100 shadow-custom-shadow-xs"
          static
        >
          <div
            ref={imagePickerRef}
                          ...
                          {unsplashImages.map((image) => (
                            ...
                            >
                              <img
                                ...
                                className="absolute start-0 top-0 h-full w-full cursor-pointer rounded object-cover"
                              />
                            </div>
                          ))}
                        </div>
                  ...
                  <div className="flex h-full w-full flex-col gap-y-2">
                    <div className="flex w-full flex-1 items-center gap-3">
                      ...
                      >
                        <button
                          type="button"
                          className="absolute end-0 top-0 z-40 -translate-y-1/2 rounded bg-custom-background-90 px-2 py-0.5 text-xs font-medium text-custom-text-200"
                        >
                          Edit
                        </button>

  ...
  return (
    <>
      {peekCycle && projectId && (
        <div
          ref={ref}
          className="flex h-full w-full max-w-[21.5rem] flex-shrink-0 flex-col gap-3.5 overflow-y-auto border-s border-custom-border-100 bg-custom-sidebar-background-100 px-4 duration-300 fixed md:relative end-0 z-[9]"
          style={{
            boxShadow:

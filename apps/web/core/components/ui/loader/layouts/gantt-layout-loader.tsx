...
export const GanttLayoutLoader = () => (
  <div className="flex flex-col h-full overflow-x-auto animate-pulse">
    ...
    <div className="flex h-full">
      <div className="h-full w-[25.5rem] border-e border-custom-border-200">
        <Row className="flex items-end h-(--header-size) py-2 border-b border-custom-border-200">
      ...
      <div className="h-full w-full border-e border-custom-border-200">
        <div className="flex flex-col justify-between gap-2 h-(--header-size) py-1.5 px-4 border-b border-custom-border-200">

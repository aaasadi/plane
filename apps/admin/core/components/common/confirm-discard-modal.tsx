      ...
      <Dialog as="div" className="relative z-50" onClose={handleClose}>
        ...
        <div className="fixed inset-0 z-10 overflow-y-auto">
          <div className="my-10 flex items-center justify-center p-4 text-center sm:p-0 md:my-32">
            ...
            >
              <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-custom-background-100 text-start shadow-custom-shadow-md transition-all sm:my-8 sm:w-[30rem]">

...
export const AdminHeader: FC = observer(() => {
  ...
  return (
    <div className="relative z-10 flex h-(--header-size) w-full flex-shrink-0 flex-row items-center justify-between gap-x-2 gap-y-4 border-b border-custom-sidebar-border-200 bg-custom-sidebar-background-100 p-4">

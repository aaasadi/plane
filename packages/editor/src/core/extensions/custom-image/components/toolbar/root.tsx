...
export const ImageToolbarRoot: React.FC<Props> = (props) => {
  ...
  return (
    <>
      <div
        className={cn(
          "absolute top-1 end-1 h-7 z-20 bg-black/80 rounded-sm flex items-center gap-2 px-2 opacity-0 pointer-events-none group-hover/image-component:opacity-100 group-hover/image-component:pointer-events-auto transition-opacity",
          {

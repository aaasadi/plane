...
const createDragHandleElement = (): HTMLElement => {
  ...
  dragHandleElement.classList.value =
    "hidden sm:flex items-center size-5 aspect-square rounded-xs cursor-grab outline-none hover:bg-custom-background-80 active:bg-custom-background-80 active:cursor-grabbing transition-[background-color,_opacity] duration-200 ease-linear";
  ...
  iconElement2.classList.value = "pointer-events-none text-custom-text-300 -ms-2.5";

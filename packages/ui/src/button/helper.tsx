...
enum buttonSizeStyling {
  sm = `px-3 py-1.5 font-medium text-xs rounded-sm flex items-center gap-1.5 whitespace-nowrap transition-all justify-center`,
  md = `px-4 py-1.5 font-medium text-sm rounded-sm flex items-center gap-1.5 whitespace-nowrap transition-all justify-center`,
  lg = `px-5 py-2 font-medium text-sm rounded-sm flex items-center gap-1.5 whitespace-nowrap transition-all justify-center`,
  xl = `px-5 py-3.5 font-medium text-sm rounded-sm flex items-center gap-1.5 whitespace-nowrap transition-all justify-center`,
}

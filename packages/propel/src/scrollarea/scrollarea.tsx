...
const thumbSizeStyles = {
  sm: "before:absolute before:start-1/2 before:top-1/2 before:size-full before:min-h-11 before:min-w-11 before:-translate-x-1/2 before:-translate-y-1/2",
  md: "before:absolute before:start-1/2 before:top-1/2 before:size-full before:min-h-14 before:min-w-14 before:-translate-x-1/2 before:-translate-y-1/2",
  lg: "before:absolute before:start-1/2 before:top-1/2 before:size-full before:min-h-17 before:min-w-17 before:-translate-x-1/2 before:-translate-y-1/2",
} as const;
...
const ScrollBar = React.memo(function ScrollBar({
  ...
  return (
    <BaseScrollArea.Scrollbar
      ...
      className={cn(
        "group/track me-1 flex justify-center rounded bg-transparent opacity-0 transition-opacity delay-300 ",

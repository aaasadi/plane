      ...
      <Accordion.Root className="w-96">
        <Accordion.Item value="item-1">
          <Accordion.Trigger asChild>
            <button className="w-full rounded-md bg-blue-500 px-4 py-2 text-start text-white hover:bg-blue-600">
        ...
        <Accordion.Item value="item-2">
          <Accordion.Trigger asChild>
            <button className="w-full rounded-md bg-green-500 px-4 py-2 text-start text-white hover:bg-green-600">
